...
def select_images(info_dict):
    for b in info_dict["bboxes"]:
        if b["class"] == "Person":
            return True
        # elif b["class"] == "MotorCycle":
        #     return True
    return False

if __name__ == '__main__':
    # src = 'C:/Users/Minji/Documents/people_counting/labels'
    xml_src = "C:/Users/Minji/Documents/smart_road/labels/src/"
    # txt_src = os.path.join(src, "src2")
    # config_name = "ClassMapping_people.csv"
    #
    img_src = "C:/Users/Minji/Documents/smart_road/images/src/"
    selected_img_src = "C:/Users/Minji/Documents/smart_road/images/selected/"

    selected_xml_src = "C:/Users/Minji/Documents/smart_road/labels/selected/"
    ...
    for ann in tqdm(annotations):
        ...
        if select_images(info_dict):
            shutil.move(os.path.join(img_src, os.path.basename(ann).replace("xml", "jpg")), os.path.join(selected_img_src, os.path.basename(ann).replace("xml", "jpg")))
            shutil.move(ann, os.path.join(selected_xml_src, os.path.basename(ann)))